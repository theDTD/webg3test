...
describe("FAQ - buy used textbooks by subject test",()=>{
    it("should render properly",()=> {
        const component = <BuyUsedTextbooksBySubject domain="http://localhost" />;
        ...
        for(let i=0; i<17; i++) {
            const ul1li = ul1.props.children[i];
            ...
            const ul2li = ul2.props.children[i];
            ...
            const ul3li = ul3.props.children[i];
