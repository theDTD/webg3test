...
describe("FAQ - why rent test",()=> {
    it("should render properly", () => {
        const component: JSX.Element = <WhyRent />;
        ...
        for(let i=0; i<10; i++) {
            const p: TestRenderer.ReactTestInstance = container.props.children[i+1];
            ...
            if (i<7) {
                ...
                const pContent: TestRenderer.ReactTestInstance = p.props.children;
                expect(pContent.type).toEqual("span");
