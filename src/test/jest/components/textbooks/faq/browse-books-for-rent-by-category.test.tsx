...
describe("FAQ - browse books for rent by category test", ()=>{
    it("should render properly", ()=>{
        const component: JSX.Element = <BrowseBooksForRentByCategory domain="http://localhost" />;
        ...
        const ul1List: {href: string, name: string}[] = [
        ...
        const ul2List: {href: string, name: string}[] = [
        ...
        const ul3List: {href: string, name: string}[] = [
        ...
        for(let i=0; i<11; i++) {
            ...
            const ul1Li: ReactTestInstance = ul1.props.children[i].props.children;
            ...
            const ul2Li: ReactTestInstance = ul2.props.children[i].props.children;
            ...
            const ul3Li: ReactTestInstance = ul3.props.children[i].props.children;
        ...
        const ul1li12: ReactTestInstance = ul1.props.children[11].props.children;
