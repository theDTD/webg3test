...
describe("Textbook Rental Savings", () => {
    it("Textbook Rental Savings component should render properly", () => {
        ...
        const component = <TextbookRentalSavings domain="https://localhost.test.domain" popularRentalProducts={popularRentals} />
        const renderedComponent = TestRenderer.create(component);
        const root = renderedComponent.root;

        const body = root.findByType("div");
        ...
        const rentalWrapper = body.props.children[1];
        ...
        for(let i=0; i<popularRentals.length; i++) {
            ...
            const bookImg =  bookLink.props.children;
            ...
            const title = bookDetails.props.children[0];
            ...
            const author = bookDetails.props.children[1];
            ...
            const listPrice = bookDetails.props.children[2];
            ...
            const rentTextLink = rentText.props.children[1];
            ...
            const savings = bookDetails.props.children[4];
